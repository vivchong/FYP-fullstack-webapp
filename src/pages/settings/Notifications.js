import { Flex, Heading, Text, Stack, Box, Icon, Spacer, Button } from '@chakra-ui/react';
              ...
              >
                <Flex gap={10}>
                  ...
                  <Flex flexDir="column" gap={2}>
                    <Text fontWeight="medium">"{request.sig_name}" is gaining popularity!</Text>
                    <Text>
                      Someone submitted a request to join your SIG. They are waiting for your response.
                    </Text>
                    <Flex>
                      <Spacer />
                      <Button
